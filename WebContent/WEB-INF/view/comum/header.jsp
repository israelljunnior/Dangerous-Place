...
<body>
	<nav class="navbar navbar-inverse" style="background: #1C1C1C;">
		<div class="collapse navbar-collapse" style="margin-top: 3px" >
				...
				<li><a href="/PP2-DangerousPlace/" data-toggle="tooltip"><p class="names">Home</p></a></li>

				<li><a href="/PP2-DangerousPlace/usuario/forum"><p class="names">Fórum</p></a></li>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/jquery.validate.min.js"></script>
...
<link type="text/javascript" src="<%=request.getContextPath()%>/resources/bootstrap/js/bootstrap.min.js">
