...
public class Util {
	...
	public static boolean fazerUploadImagem(MultipartFile imagem) {
		...
		if (!imagem.isEmpty()) {
			...
			try { // Criando o diretório para armazenar o arquivo
				String workspaceProjeto = "C:/Users/gleic/eclipse-workspace/controle-estoque"; File dir = new
					File(workspaceProjeto + "/WebContent/resources/img"); if (!dir.exists()) {
					dir.mkdirs(); }
